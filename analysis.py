...
# add notes to readme? get help from chatgpt on this. 
# find out how to upload to github.
# Add github link to C.V.

# Try to find an internship for another project. 
# Learn sql.. 
# learn aggregations and transformations for sql and pandas. 
